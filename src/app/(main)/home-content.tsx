// src/app/(main)/home-content.tsx
// Componente de servidor: só a seção de portfólio (troca de fundo por slide) precisa
// de estado no cliente, então foi isolada em _components/PortfolioHighlightSection —
// o resto da home (hero, serviços, números, FAQ) renderiza como HTML estático.

import { ReactNode } from 'react';
import Image from 'next/image';
import Link from "next/link";
import { YouTubeEmbed } from '@next/third-parties/google';
import { PortfolioHighlightSection } from './_components/PortfolioHighlightSection';
...
type HomeService = { name: string; slug: string; shortDescription: string; icon: string };
...
export default function HomeContent({ heroVideoId, heroVideoIsVertical, portfolioItems, faqItems, services, googleReviews }: HomeContentProps) {
  ...
  return (
    <>
      ...
      {/* --- SEÇÃO DE PORTFÓLIO (única parte da home que precisa ser client) --- */}
      <PortfolioHighlightSection portfolioItems={portfolioItems} />
