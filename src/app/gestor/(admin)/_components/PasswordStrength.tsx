...
type PasswordStrengthProps = {
  password?: string;
  minLength?: number; // Adicionamos esta prop
};
...
export const PasswordStrength = ({ password = '', minLength = 10 }: PasswordStrengthProps) => {
  // Define as regras de validação
  const hasMinChars = password.length >= minLength; // Agora usa a prop
