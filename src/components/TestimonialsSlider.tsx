...
// A CORREÇÃO ESTÁ AQUI: Adicionamos o nome "TestimonialsSlider" depois de "function"
export const TestimonialsSlider = memo( function TestimonialsSlider({ testimonials, onActiveIndexChange }: { testimonials: Testimonial[], onActiveIndexChange: (index: number) => void }) {
 return ( <div className="relative slider-container-padded">
 <Swiper
 ...
 onSlideChangeTransitionEnd={(swiper) => onActiveIndexChange(swiper.realIndex)} // Corrigido para onSlideChangeTransitionEnd
 >
